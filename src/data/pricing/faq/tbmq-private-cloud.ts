	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Yes, TBMQ Private Cloud subscription has sessions, messages, and storage limits. See subscription <a target="_blank" href="/docs/pe/subscription/" rel="noopener noreferrer">documentation</a> for more details.</p>',
			},
		],
	},
	{
