	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: `<p>The annual renewal fee for the Perpetual License depends on the total value of your license. <a target="_blank" href="/contact-us/" rel="noopener noreferrer">Contact us</a> for more details.</p>`,
			},
			{
			...
			},
			{
				...
				answer: `<p>Since the Perpetual License is a one-time purchase granting lifetime access, all sales are final. However, we encourage customers to explore our subscription options before committing to a perpetual license. Subscriptions provide full access to TBMQ Professional Edition, allowing you to evaluate its features and scalability. If you need guidance on selecting the best licensing option for your needs, our <a target="_blank" href="/contact-us/" rel="noopener noreferrer">sales team</a> is happy to assist you.</p>`,
			},
			{
				id: 'tbmq-perp-bulk-discount',
				question: 'Do you offer discounts for multiple licenses?',
				answer: `<p><a target="_blank" href="/contact-us/" rel="noopener noreferrer">Contact our sales team</a> for bulk pricing options.</p>`,
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: `<p>By default, the platform requires active Internet access or at least access to License server from your host machine. If Offline access is a must, please <a target="_blank" href="/contact-us/" rel="noopener noreferrer">contact us</a> to discuss options.</p>`,
			},
			{
				id: 'tbmq-perp-backup',
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: `<p>Yes, you can convert your self-managed subscription to a perpetual license by purchasing the perpetual license and replacing the license key in the configuration files. For more details, please <a target="_blank" href="/contact-us/" rel="noopener noreferrer">contact us</a>.</p>`,
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: `<p>Yes, you can purchase additional services such as managed services, advanced SLAs, consultancy, development, and training. For more details, please <a target="_blank" href="/contact-us/" rel="noopener noreferrer">contact our sales team</a>.</p>`,
			},
			{
				id: 'tbmq-perp-24-7',
