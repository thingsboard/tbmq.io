	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: `<p>Yes. Per tenant, device and user limits prevent abuse and protect cluster health. The full tables are published <a target="_blank" href="https://thingsboard.io/docs/private-cloud/subscription/" rel="noopener noreferrer">on the Private Cloud subscription page</a>.</p>`,
			},
			{
