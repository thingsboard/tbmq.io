...
export const tbmqCeFaq: FaqCategory[] = [
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Yes, the source code is available on <a target="_blank" href="https://github.com/thingsboard/tbmq" rel="noopener noreferrer">GitHub</a>, and you can fork and modify it according to your requirements. By the way, please consider starring our <a target="_blank" href="https://github.com/thingsboard/tbmq" rel="noopener noreferrer">repository★</a>.</p>',
			},
			{
				id: 'tbmq-ce-internet',
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Yes, official Docker images are available on <a target="_blank" href="https://hub.docker.com/r/thingsboard/tbmq" rel="noopener noreferrer">Docker Hub</a>.</p>',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>The Professional Edition offers advanced features such as White Labeling, RBAC, Single sign-on, etc. You can find a more detailed comparison <a target="_blank" href="/#comparison-features" rel="noopener noreferrer">on the TBMQ product page</a>.</p>',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Yes, you are welcome to submit feature requests on <a target="_blank" href="https://github.com/thingsboard/tbmq/issues" rel="noopener noreferrer">GitHub</a>. After the product team reviews them, they may be added to the backlog.</p>',
			},
			{
			...
			},
			{
				...
				answer: '<p>Yes, updates for all <a target="_blank" href="https://github.com/thingsboard/tbmq/releases" rel="noopener noreferrer">versions</a> are available.</p>',
			},
			{
			...
			},
			{
				...
				answer: '<p>You can report it on <a target="_blank" href="https://github.com/thingsboard/tbmq/issues" rel="noopener noreferrer">GitHub</a>, and the open-source community may help fix it.</p>',
			},
			{
				id: 'tbmq-ce-contribute',
				question: 'Can I contribute to the development of TBMQ Community Edition?',
				answer: '<p>Yes! Pull requests and contributions are welcome on <a target="_blank" href="https://github.com/thingsboard/tbmq" rel="noopener noreferrer">GitHub</a>.</p>',
			},
		],
	},
	{
