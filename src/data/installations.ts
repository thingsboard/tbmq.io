		...
		features: [
			[
				...
				},
				{
					...
					href: '/docs/mqtt-broker/pe/architecture/',
					target: '_blank',
			...
			[
				{
					...
					href: '/docs/mqtt-broker/pe/getting-started/',
					target: '_blank',
				...
				cards: [
					{
						...
						logoAlt: 'Docker (Linux or Mac OS)',
						title: 'Docker (Linux or Mac OS)',
						href: '/docs/mqtt-broker/pe/installation/docker/',
						target: '_blank',
					},
					{
						logo: install('docker-windows.svg'),
						logoAlt: 'Docker (Windows)',
						title: 'Docker (Windows)',
						href: '/docs/mqtt-broker/pe/installation/docker-windows/',
						target: '_blank',
					},
					{
						...
						href: '/docs/mqtt-broker/pe/installation/cluster/docker-compose-setup/',
						target: '_blank',
					},
					{
						...
						href: '/docs/mqtt-broker/pe/installation/cluster/minikube-cluster-setup/',
						target: '_blank',
					},
				],
			},
				...
				cards: [
					{
						...
						href: '/docs/mqtt-broker/pe/installation/cluster/aws-cluster-setup/',
						target: '_blank',
					},
					{
						logo: install('azure.svg'),
						...
						href: '/docs/mqtt-broker/pe/installation/cluster/azure-cluster-setup/',
						target: '_blank',
					},
					{
						logo: install('gcp.svg'),
						...
						href: '/docs/mqtt-broker/pe/installation/cluster/gcp-cluster-setup/',
						target: '_blank',
					},
					{
						...
						href: '/docs/mqtt-broker/pe/installation/?installationType=helm',
						target: '_blank',
					},
				],
			},
