...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-ie-communication.png', alt: 'TBMQ Integration Executor internal communication diagram', caption: 'TBMQ Integration Executor internal communication diagram' },
]} />
...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-ie-msg-processing.png', alt: 'TBMQ integration message processing flow', caption: 'TBMQ integration message processing flow' },
]} />
...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-ie-admin-timeout.png', alt: 'Validation timeout — Integration Executor not running', caption: 'Validation timeout — Integration Executor not running' },
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-ie-admin-error.png', alt: 'Validation failure — configuration error', caption: 'Validation failure — configuration error' },
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-ie-admin-ok.png', alt: 'Validation success — integration saved and activated', caption: 'Validation success — integration saved and activated' },
]} />
