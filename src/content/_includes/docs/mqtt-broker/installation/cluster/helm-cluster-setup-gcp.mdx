...
You will apply the key later, in [Configure license and broker images](#configure-license-and-broker-images).
</ShowFor>
...
For the version history of TBMQ itself and the supported upgrade paths between its versions, see the
<DocLink product={props.product} path="installation/upgrade-instructions">upgrade instructions</DocLink> page.

<Aside type="note">
  If you scrape TBMQ metrics, review the <DocLink product={props.product} path="releases/#v240-august-27-2026">2.4.0 release notes</DocLink> before upgrading to v2.4.0.
