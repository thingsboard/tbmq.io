...
<DocLink product={props.product} path="installation/config">configuration</DocLink> settings:
...
| **MQTT Publish Controller** | Publish an MQTT message to subscribers |
...
For worked examples, see <DocLink product={props.product} path="user-management">User management</DocLink>,
<DocLink product={props.product} path="mqtt-client-credentials-management">MQTT client credentials management</DocLink>,
<DocLink product={props.product} path="application-shared-subscription">Application shared subscriptions management</DocLink>,
and <DocLink product={props.product} path="mqtt-message-publishing">MQTT message publishing</DocLink>.
