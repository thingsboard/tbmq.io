...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-kafka-integration.png', alt: 'TBMQ Kafka integration data flow', caption: 'TBMQ Kafka integration data flow' },
]} />
