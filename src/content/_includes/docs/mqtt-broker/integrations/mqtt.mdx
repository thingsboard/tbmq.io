...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-mqtt-integration.png', alt: 'TBMQ MQTT integration data flow', caption: 'TBMQ MQTT integration data flow' },
]} />
