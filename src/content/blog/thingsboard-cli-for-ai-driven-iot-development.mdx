...
Meet **ThingsBoard CLI** — a new command-line tool that works with Claude Code to build IoT solutions from scratch, evolve anything already running in your tenant, and ship the same configuration to every environment you care about. Available today for [ThingsBoard PE](/docs/pe/user-guide/cli/) 4.3.1.2+ and [ThingsBoard Cloud](https://thingsboard.cloud/signup).
...
Managing your IoT setup doesn't have to mean clicking through the UI. With ThingsBoard CLI, building the first version, shipping it to production, and evolving it for the next five years all happen the same way — as a conversation with Claude, as files on disk, as one `tb push`. Available today for [ThingsBoard PE](/docs/pe/user-guide/cli/) 4.3.1.2+ and [ThingsBoard Cloud](https://thingsboard.cloud/signup).
