---
title: 'TBMQ 2.2: JWT Auth and Client Blocking'
description: 'TBMQ 2.2 release: pluggable JWT authentication, client blocking, and other security improvements for production MQTT deployments at scale.'
date: 2025-09-01
...
We’re excited to announce the release of TBMQ [2.2.0](/docs/releases/)! This release brings powerful new features that make TBMQ more secure, resilient, and easier to operate in production at scale.
...
![MQTT authentication providers overview in TBMQ 2.2](/images/blog/tbmq-2-2-strengthening-mqtt-security-with-jwt-and-client-blocking/mqtt_authentication_providers.webp)
...
![JWT authentication configuration in TBMQ 2.2](/images/blog/tbmq-2-2-strengthening-mqtt-security-with-jwt-and-client-blocking/jwt_authentication_3x.webp)
...
![Blocked clients management in TBMQ 2.2 security feature](/images/blog/tbmq-2-2-strengthening-mqtt-security-with-jwt-and-client-blocking/blocked_clients_3x.webp)
...
![MQTT backpressure handling diagram in TBMQ 2.2](/images/blog/tbmq-2-2-strengthening-mqtt-security-with-jwt-and-client-blocking/mqtt_backpressure.webp)
...
TBMQ 2.2 delivers important advancements in security, reliability, and performance — but this post only scratches the surface. We encourage you to review the full [release notes](/docs/releases/) to explore all improvements and fixes included in this version.
