---
title: 'TBMQ 2.1: Embedded Integrations for MQTT Data'
description: 'TBMQ 2.1 release: Integration Executor microservice with HTTP, Kafka, and MQTT outbound integrations, plus the official Helm Chart for K8s deployments.'
date: 2025-04-29
...
We’re excited to announce the release of TBMQ [2.1.0](/docs/releases/)! This version marks a major milestone by introducing the Integration Executor microservice, which is responsible for managing integrations. It powers scalable and multi-protocol message delivery to external systems, starting with support for HTTP, Kafka, and MQTT outbound integrations. We’ve also released the official [Helm Chart](/docs/installation/) for TBMQ, simplifying deployment and management of the infrastructure in K8s environments.

## Integration executor

![Integration executor architecture in TBMQ 2.1](/images/blog/tbmq-2-1-new-chapter-in-mqtt-messaging-with-embedded-integrations/integration-executor-4.webp)
...
This architecture ensures fault-tolerant, no-loss message delivery, powered by Kafka-backed buffering and resilient processing. Learn more about how the Integration Executor works in our [official documentation](/docs/integrations/).
...
![HTTP integration setup in TBMQ 2.1 embedded integrations](/images/blog/tbmq-2-1-new-chapter-in-mqtt-messaging-with-embedded-integrations/http-1.webp)
...
![MQTT-to-MQTT integration setup in TBMQ 2.1](/images/blog/tbmq-2-1-new-chapter-in-mqtt-messaging-with-embedded-integrations/mqtt-1.webp)
...
![Kafka embedded integration in TBMQ 2.1](/images/blog/tbmq-2-1-new-chapter-in-mqtt-messaging-with-embedded-integrations/kafka-1.webp)
...
![Helm chart deployment configuration for TBMQ 2.1](/images/blog/tbmq-2-1-new-chapter-in-mqtt-messaging-with-embedded-integrations/helm-tbmq2.webp)

Helm is the most widely adopted package manager for Kubernetes. It simplifies the deployment and management of complex applications by bundling all Kubernetes manifests and configuration options into reusable charts. With our [Helm chart](/docs/installation/?installationType=helm), TBMQ users can deploy the entire stack, including Broker nodes, Integration Executors, and dependencies, in a repeatable and standardized way using just a few commands.
...
Check out the full documentation on [Integrations](/docs/integrations/) and deploy TBMQ 2.1 using our official [Helm Chart on ArtifactHub](https://artifacthub.io/packages/helm/tbmq-helm-chart/tbmq-cluster).
